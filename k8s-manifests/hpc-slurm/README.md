...
For production deployments with dynamic autoscaling, consider using
[Slinky](https://www.schedmd.com/slinky/why-slinky/) instead. See
`docs/guides/k8s-native-setup.md` for Slinky setup instructions.
