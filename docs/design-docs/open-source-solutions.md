...
Network Isolation: A foundational element of the dual-stack design is strict network separation. This is achieved by creating two distinct libvirt virtual network bridges, hpc-net (192.168.100.0/24) and pharos-net (192.168.200.0/24). This creates two separate Layer 2 broadcast domains, preventing network interference and allowing for independent IP addressing and network policies, thereby emulating the logical separation of production HPC and cloud networks.1
